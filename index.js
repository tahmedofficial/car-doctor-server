...
app.use(cors({
    origin: [
        // "http://localhost:5173",
        "https://car-doctor-client-23c44.web.app",
        "https://car-doctor-client-23c44.firebaseapp.com"
    ], credentials: true
}));
...
const verifyToken = (req, res, next) => {
    ...
    console.log("token in the niddleware", token);
    if (!token) {
        return res.status(401).send({ message: "unauthorizwd access" })
    }
